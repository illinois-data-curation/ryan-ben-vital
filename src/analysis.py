...
# accidents import 
df1 = pd.read_csv(os.path.join(raw_data_path, 'iowa1.csv'))
df2 = pd.read_csv(os.path.join(raw_data_path, 'iowa2.csv'))
df3 = pd.read_csv(os.path.join(raw_data_path, 'iowa3.csv'))

df_accidents = pd.concat([df1, df2, df3], ignore_index=True)


df_ncei = pd.read_csv(os.path.join(raw_data_path, 'ncei.csv'))
